...
Capybara.default_driver = :rack_test # Driver par défaut pour les tests non-JavaScript
Capybara.default_max_wait_time = 5 # Temps d'attente maximum pour les éléments
